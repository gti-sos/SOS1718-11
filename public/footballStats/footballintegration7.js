 ...
 angular.module("StatsManagerApp").controller("FootballIntegration7Ctrl", ["$scope", "$http", "$rootScope", function($scope, $http, $rootScope) {
  ...
  $http.get(api + '?apikey=' + $rootScope.apikey).then(function(response) {
                    ...
                    $http.get("https://sos1718-10.herokuapp.com/api/v1/motogp-stats").then(function(response) {
                            ...
                            console.log("Numero total de goles" + sumagoles);
                            console.log("Numero total de corner" + sumafaltas);
                            console.log("Numero total de faltas" + sumafaltas);
                            console.log("Numero total de score" + sumascore);




 
score=JSON.stringify(sumascore);
